...
export default function BitcoinDriveAbout() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#000000' }}>
      {/* Navigation */}
      <nav className="border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.12)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link href="/" className="flex items-center space-x-2">
                <span className="text-2xl font-bold" style={{ color: '#00ff88' }}>₿</span>
                <span className="text-xl font-bold" style={{ color: '#ffffff' }}>Bitcoin Drive</span>
              </Link>
            </div>
            <div className="flex items-center space-x-6">
              ...
              >
                <Github className="w-5 h-5" style={{ color: '#00ff88' }} />
              </a>
              <a 
                ...
                className="hover:opacity-80 transition-opacity"
              >
                <Twitter className="w-5 h-5" style={{ color: '#00ff88' }} />
              </a>
              <Link 
                href="/"
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 20% 50%, rgba(0, 255, 136, 0.2) 0%, transparent 50%),
                            radial-gradient(circle at 80% 80%, rgba(0, 255, 136, 0.1) 0%, transparent 50%)`
          }} />
        </div>
        
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6" style={{ color: '#00ff88' }}>
            Store Forever.
            <br />
            <span className="opacity-80">Verify Always.</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
      ...
      <section id="features" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12" style={{ color: '#00ff88' }}>
            Why Bitcoin Drive?
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div
                ...
                style={{ 
                  backgroundColor: hoveredFeature === index ? 'rgba(0, 255, 136, 0.1)' : 'rgba(255, 255, 255, 0.05)',
                  border: '1px solid rgba(255, 255, 255, 0.12)'
                }}
                onMouseEnter={() => setHoveredFeature(index)}
                onMouseLeave={() => setHoveredFeature(null)}
              >
                <div className="mb-4" style={{ color: '#00ff88' }}>
                  {feature.icon}
                </div>
      ...
      {/* How It Works */}
      <section className="py-20 px-4" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12" style={{ color: '#00ff88' }}>
            How It Works
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#00ff88' }}>Upload</h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#00ff88' }}>Verify</h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: '#00ff88' }}>Share</h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
            ...
            {pricingPlans.map((plan, index) => (
              <div
                ...
                style={{ 
                  ...
                  border: plan.popular ? '2px solid #00ff88' : '1px solid rgba(255, 255, 255, 0.12)'
                }}
              >
                {plan.popular && (
                ...
                <h3 className="text-2xl font-bold mb-2" style={{ color: '#00ff88' }}>
                  {plan.name}
                </h3>
                <div className="mb-6">
                  <span className="text-4xl font-bold" style={{ color: '#00ff88' }}>
                    ${plan.price}
                  </span>
                  {plan.price !== "Custom" && (
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-start">
                      <Check className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" style={{ color: '#00ff88' }} />
                ...
                <button
                  ...
                  style={{ 
                    backgroundColor: plan.popular ? '#00ff88' : 'transparent',
                    color: plan.popular ? '#000000' : '#00ff88',
                    border: plan.popular ? 'none' : '2px solid #00ff88'
                  }}
                >
                  {plan.cta}
                </button>
      ...
      <section className="py-20 px-4" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6" style={{ color: '#00ff88' }}>
      ...
      {/* Footer */}
      <footer className="py-8 px-4 border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.12)' }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            <span className="text-xl font-bold" style={{ color: '#00ff88' }}>₿</span>
            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
              © 2025 Bitcoin Drive. Built on Bitcoin SV.
            </span>
          </div>
          <div className="flex space-x-6">
            <a href="#" className="hover:opacity-80 transition-opacity" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
              Privacy
            </a>
            <a href="#" className="hover:opacity-80 transition-opacity" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
              Terms
