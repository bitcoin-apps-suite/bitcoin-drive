...
const Dock: React.FC<DockProps> = ({ currentApp = 'bitcoin-drive' }) => {
  ...
  const dockApps: DockApp[] = [
    ...
    { name: 'Bitcoin Writer', icon: FileText, color: 'rainbow', url: 'https://thebitcoincorporation.website' },
    { name: 'Bitcoin Code', icon: Code2, color: 'rainbow', url: 'https://bitcoin-code.vercel.app' },
    { name: 'Bitcoin Drive', icon: HardDrive, color: 'rainbow', url: 'https://bitcoin-drive.vercel.app', current: currentApp === 'bitcoin-drive' },
